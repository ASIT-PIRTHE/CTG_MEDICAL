    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your VistaLOAN Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your VistaLOAN Account";
                    ...
                    public static LocalText FormTitle = "Sign up for VistaLOAN";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "VistaLOAN";
        }
        ...
        public static class Site
        {
            ...
            {
                public static LocalText UpperLeftModuleName = "Loan Management System";
                public static LocalText UpperLeftClientName = "Bangladesh Export Processing Zones Authority";
                public static LocalText PageTitleSuffix = "LMS";
